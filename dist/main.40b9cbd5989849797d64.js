...
var ___HTML_LOADER_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(5347), __webpack_require__.b);
var ___HTML_LOADER_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(359), __webpack_require__.b);
var ___HTML_LOADER_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(2727), __webpack_require__.b);
var ___HTML_LOADER_IMPORT_3___ = new URL(/* asset import */ __webpack_require__(489), __webpack_require__.b);
// Module
...
var code = "<!DOCTYPE html> <html lang=\"en\"> <head> <meta charset=\"UTF-8\"/> <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"/> <meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"/> <title>Document</title> </head> <body> <header class=\"header\"> <nav class=\"header__navbar\"> <div class=\"menu-btn-mobile\"> <span></span> <span></span> <span></span> </div> <div class=\"header__navbar__navbar__title-logo\"> <p class=\"logo\">Bookshop</p> </div> <div class=\"navbar__nav\"> <a class=\"nav__item-link nav__item-link_active\" href=\"#\">Books</a> <a class=\"nav__item-link\" href=\"#\">Audiobooks</a> <a class=\"nav__item-link\" href=\"#\">Stationery &amp gifts</a> <a class=\"nav__item-link\" href=\"#\">blog</a> </div> <div class=\"icon-navbar\"> <div class=\"icon-navbar__icon-img\"> <img class=\"icon-navbar__icon-img\" src=\"" + ___HTML_LOADER_REPLACEMENT_0___ + "\" alt=\"icon-user\"/> </div> <div class=\"icon-navbar__icon-img\"> <img class=\"icon-navbar__icon-img\" src=\"" + ___HTML_LOADER_REPLACEMENT_1___ + "\" alt=\"icon-search\"/> </div> <div class=\"icon-navbar__icon-img\"> <img class=\"icon-navbar__icon-img icon-shop-bag\" src=\"" + ___HTML_LOADER_REPLACEMENT_2___ + "\" alt=\"icon-shop\"/> <p class=\"shop-bag bags-items\">0</p> </div> </div> </nav> </header> <main> <div class=\"wrapper\"> <div class=\"miniCard_second\"> <a href=\"\" class=\"title__card\" title=\"card-Book\"> top<br/> 100<br/>Books<br/>2022 </a> <img class=\"arrow-right\" src=\"" + ___HTML_LOADER_REPLACEMENT_3___ + "\" alt=\"arrow-right\"/> </div> </div> <div class=\"content-1\"> <div class=\"miniCards\"> <div class=\"miniCard-first\"> <a href=\"\" class=\"title__card\" title=\"card-books\"> Change<br/> old book<br/>on new </a> <img class=\"arrow-right\" src=\"" + ___HTML_LOADER_REPLACEMENT_3___ + "\" alt=\"arrow-right\"/> </div> </div> <div class=\"main-container-block\"></div> <div class=\"slider-dots\"></div> </div> <div class=\"content-2\"> <div class=\"div-back-ground-list\"> <div class=\"menu-mobile-category\"> <span></span> <span></span> <span></span> </div> </div> <div class=\"container-info\"> <div class=\"categories-books mobile-category\"> <ul class=\"categories-list\"> <li class=\"menu-item active n0\" data-index=\"0\" data-name=\"subject:Art\">Art &amp; Fashion</li> <li class=\"menu-item n1\" data-index=\"1\" data-name=\"subject:Architecture\">Architecture</li> <li class=\"menu-item n2\" data-index=\"2\" data-name=\"subject:Biography &amp; Autobiography\">Biography</li> <li class=\"menu-item n3\" data-index=\"3\" data-name=\"subject:Business\">Business</li> <li class=\"menu-item n4\" data-index=\"4\" data-name=\"subject:Crafts &amp; Hobbies\">Crafts &amp; Hobbies</li> <li class=\"menu-item n5\" data-index=\"5\" data-name=\"subject:Drama\">Drama</li> <li class=\"menu-item n6\" data-index=\"6\" data-name=\"subject:Fiction\">Fiction</li> <li class=\"menu-item n7\" data-index=\"7\" data-name=\"subject:Cooking\">Food &amp; Drink</li> <li class=\"menu-item n8\" data-index=\"8\" data-name=\"subject:Health &amp; Fitness\">Health &amp; Wellbeing</li> <li class=\"menu-item n9\" data-index=\"9\" data-name=\"subject:History\">History &amp; Politics</li> <li class=\"menu-item n10\" data-index=\"10\" data-name=\"subject:Humor\">Humor</li> <li class=\"menu-item n11\" data-index=\"11\" data-name=\"subject:Poetry\">Poetry</li> <li class=\"menu-item n12\" data-index=\"12\" data-name=\"subject:Psychology\">Psychology</li> <li class=\"menu-item n13\" data-index=\"13\" data-name=\"subject:Science\">Science</li> <li class=\"menu-item n14\" data-index=\"14\" data-name=\"subject:Technology\">Technology</li> <li class=\"menu-item n15\" data-index=\"15\" data-name=\"subject:Travel\">Travel &amp; Maps</li> </ul> </div> <div class=\"output-books\"></div> </div> </div> <footer></footer> </main> </body> </html> ";
// Exports
/* harmony default export */ var src = ((/* unused pure expression or super */ null && (code)));
;// CONCATENATED MODULE: ./src/script-slider.js

let script_slider_images = [{
  slide: "slide-1",
  url: __webpack_require__(6611),
...
function initSlider(options) {
  if (!script_slider_images || !script_slider_images.length) return;
  options = options || {
    info: false,
    dots: true,
    autoplay: false
  ...
  function initImages() {
    script_slider_images.forEach((image, index) => {
      let imageDiv = `<div class="main-content image n${index} ${index === 0 ? "active" : ""}" style="background-image:url(${script_slider_images[index].url})" data-index="${index}">
            <h1 class="slider-title slide${index}">${script_slider_images[index].title}</h1>
            <div class="slider-info slide${index} n${index}">
              <div class="info1"><h2>${script_slider_images[index].info1}</h2></div> 
              <div class="info2"><h1>${script_slider_images[index].info2}</h1></div> 
              <div class="info3"><h2>${script_slider_images[index].info3}</h2></div> 
            </div>
        </div>
         `;
    ...
    sliderArrows.querySelectorAll(".slider__arrow").forEach(arrow => {
      arrow.addEventListener("click", function () {
        ...
        if (arrow.classList.contains("left")) {
          nextNumber = curNumber === 0 ? script_slider_images.length - 1 : curNumber - 1;
        } else {
          nextNumber = curNumber === script_slider_images.length - 1 ? 0 : curNumber + 1;
        }
  ...
  function initNavigateSlide() {
    script_slider_images.forEach((image, index) => {
      let eliElement = `<li class="town_item ">
            <a class="click_A n${index} ${index === 0 ? "active_hover_A" : ""} " data-index="${index}" href="#">${script_slider_images[index].name}</a>
            </li>`;
  ...
  function initTitles() {
    let titleDiv = `<div class="slider__images-title">${script_slider_images[0].title}</div>`;
  ...
  function initAutoplay() {
    setInterval(() => {
      let curNumber = +block_slide.querySelector(".active").dataset.index;
      let nextNumber = curNumber === script_slider_images.length - 1 ? 0 : curNumber + 1;
      moveSlider(nextNumber);
...
// EXTERNAL MODULE: ./src/search-books-script.js
var search_books_script = __webpack_require__(1529);
// EXTERNAL MODULE: ./src/button-media.js
var button_media = __webpack_require__(8791);
...
/******/ 	var __webpack_exports__ = __webpack_require__(8267);
/******/ 	
/******/ })()
;